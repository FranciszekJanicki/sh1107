...
static sh1107_err_t sh1107_gpio_write(sh1107_t const *sh1107, uint32_t pin,
                                      bool state) {
  return sh1107->interface.gpio_write
             ? sh1107->interface.gpio_write(sh1107->interface.gpio_user, pin,
                                            state)
             : SH1107_ERR_NULL;
}
...
static sh1107_err_t sh1107_bus_transmit(sh1107_t const *sh1107,
  ...
  return sh1107->interface.bus_transmit
             ? sh1107->interface.bus_transmit(sh1107->interface.bus_user, data,
                                              data_size)
             : SH1107_ERR_NULL;
}
...
static sh1107_err_t sh1107_bus_transmit_command(sh1107_t const *sh1107,
                                                uint8_t *data,
                                                size_t data_size) {
  sh1107_err_t err = sh1107_gpio_write(sh1107, sh1107->config.control_pin,
...
sh1107_err_t sh1107_initialize(sh1107_t *sh1107, sh1107_config_t const *config,
...
sh1107_err_t sh1107_display_frame_buf(sh1107_t const *sh1107) {
  ...
  for (uint8_t page = 0; page < (SH1107_SCREEN_HEIGHT / 8); page++) {
    ...
    err |= sh1107_bus_transmit_display(
        sh1107, sh1107->frame_buf + page * SH1107_SCREEN_WIDTH,
        SH1107_SCREEN_WIDTH);
  }
...
sh1107_err_t sh1107_set_pixel(sh1107_t *sh1107, uint8_t x, uint8_t y,
                              bool color) {
  assert(sh1107);
...
sh1107_err_t sh1107_draw_line(sh1107_t *sh1107, uint8_t x0, uint8_t y0,
                              uint8_t x1, uint8_t y1, bool color) {
  assert(sh1107);
...
sh1107_err_t sh1107_draw_rect(sh1107_t *sh1107, uint8_t x, uint8_t y, uint8_t w,
                              uint8_t h, bool color) {
  assert(sh1107);
...
sh1107_err_t sh1107_draw_circle(sh1107_t *sh1107, uint8_t x0, uint8_t y0,
...
sh1107_err_t sh1107_draw_bitmap(sh1107_t *sh1107, uint8_t x, uint8_t y,
                                uint8_t w, uint8_t h, uint8_t *bitmap,
                                size_t bitmap_size, bool color) {
  assert(sh1107);
...
sh1107_err_t sh1107_draw_string(sh1107_t *sh1107, uint8_t x, uint8_t y,
                                char const *s) {
  assert(sh1107);
...
sh1107_err_t sh1107_draw_string_formatted(sh1107_t *sh1107, uint8_t x,
                                          uint8_t y, char const *fmt, ...) {
  assert(sh1107);
...
sh1107_err_t sh1107_send_read_id_cmd(sh1107_t const *sh1107, uint8_t busy,
                                     uint8_t on_off, uint8_t id) {
  assert(sh1107);
