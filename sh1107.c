...
//     sh1107_bus_transmit_command(sh1107,(0xD5); // Set Display Clock Divide Ratio
//     sh1107_bus_transmit_command(sh1107,(0x80);
...
static sh1107_err_t sh1107_gpio_init(sh1107_t const* sh1107)
{
    return sh1107->interface.gpio_init ? sh1107->interface.gpio_init(sh1107->interface.gpio_user)
                                       : SH1107_ERR_NULL;
}

static sh1107_err_t sh1107_gpio_deinit(sh1107_t const* sh1107)
{
    return sh1107->interface.gpio_deinit
               ? sh1107->interface.gpio_deinit(sh1107->interface.gpio_user)
               : SH1107_ERR_NULL;
}
...
static sh1107_err_t sh1107_bus_init(sh1107_t const* sh1107)
{
    return sh1107->interface.bus_init ? sh1107->interface.bus_init(sh1107->interface.bus_user)
                                      : SH1107_ERR_NULL;
}

static sh1107_err_t sh1107_bus_deinit(sh1107_t const* sh1107)
{
    return sh1107->interface.bus_deinit ? sh1107->interface.bus_deinit(sh1107->interface.bus_user)
                                        : SH1107_ERR_NULL;
}
                               ...
                               sh1107_interface_t const* interface)
{
    ...
    sh1107_err_t err = sh1107_bus_init(sh1107);
    err |= sh1107_gpio_init(sh1107);
...
sh1107_err_t sh1107_deinitialize(sh1107_t* sh1107)
{
    ...
    sh1107_err_t err = sh1107_bus_deinit(sh1107);
    err |= sh1107_gpio_deinit(sh1107);
